import { addProblem } from "@modules/ProblemsBoard/services/api";
...
export const ProblemDashForm = () => {
  ...
  const handleTitle = (e: React.FormEvent<HTMLInputElement>) => {
    ...
    if (e.currentTarget.value.length > 40) return;
  ...
  const handleDescription = (e: React.FormEvent<HTMLTextAreaElement>) => {
    ...
    setDescriptionCount(e.currentTarget.value.length);
  };
